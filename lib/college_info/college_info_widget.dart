...
class CollegeInfoWidget extends StatefulWidget {
  const CollegeInfoWidget({Key key}) : super(key: key);

  @override
  _CollegeInfoWidgetState createState() => _CollegeInfoWidgetState();
}

class _CollegeInfoWidgetState extends State<CollegeInfoWidget> {
